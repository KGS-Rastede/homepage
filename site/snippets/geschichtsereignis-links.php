<!-- LINKER Event -->
    <li class="relative lg:mr-auto lg:w-1/2 lg:pr-6">
      <div
        class="absolute top-0 bottom-0 left-0 mt-5 flex w-10 -translate-x-full justify-center md:w-12 lg:right-0 lg:left-auto lg:translate-x-6"
      >
        <div
