<div class="basis-1/4">
    ...
    <?php if ($image = $subpage->gallery()->toFile()) : ?>
        ...
        <div class="col-span-1 flex flex-col x-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10 h-full bg-slate-50 hover:bg-slate-100">
